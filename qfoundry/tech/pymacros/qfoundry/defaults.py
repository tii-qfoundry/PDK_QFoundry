...
default_sampleholders['QRC6'] = qfoundry_connectors6
...
default_launcher_assignement['QRC12'] = {i: f"p{i}" for i in range(12+1) }  
...
default_launcher_enabled['QRC12'] = [f'p{i+1}' for i in range(12+1)]      
